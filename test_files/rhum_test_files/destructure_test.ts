...
Rhum.testPlan('destructure.ts', () => {
  ...
  // Rhum.testSuite('Test Fragment', () => {
  //   Rhum.testCase('Input/Output', () => {
  //     const result = destructureQueries(test.testFragments);
  //     Rhum.asserts.assertEquals(test.testFragmentsResults, result);
  //   });
  // });
